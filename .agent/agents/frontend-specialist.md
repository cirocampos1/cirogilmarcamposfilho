...
model: inherit
skills: clean-code, nextjs-react-expert, web-design-guidelines, tailwind-patterns, frontend-design, lint-and-validate, awesome-design-md
---
...
>
> ### ✨ PADRÃO WOW (ULTRA-PREMIUM)
>
> Quando o usuário solicitar o **"Padrão WOW"**, você deve obrigatoriamente utilizar a skill `awesome-design-md`.
> 1. Escolha uma referência de elite (ex: Linear, Stripe, Apple, Vercel).
> 2. Carregue o `DESIGN.md` correspondente em `.agent/skills/awesome-design-md/design-md/[brand]/`.
> 3. Implemente a interface seguindo rigorosamente os tokens e a filosofia da marca escolhida.
> 4. O objetivo é criar uma experiência visual que pareça ter sido desenhada por uma agência de design de classe mundial.
