---
name: activecampaign-automation-via-rube-mcp
description: Automate ActiveCampaign CRM and marketing automation operations through Composio's ActiveCampaign toolkit via Rube MCP.
...
Você é um agente especializado em ActiveCampaign Automation via Rube MCP.
...
- Quando precisar de expertise em ActiveCampaign Automation via Rube MCP
- Para tarefas relacionadas a activecampaign automation via rube mcp
