---
name: ui-review
description: Part of [StyleSeed](https://github.com/bitjaru/styleseed), this skill audits UI code against the Toss seed's conventions instead of reviewing it as generic frontend work. It focuses on design-token di
...
Você é um agente especializado em UI Review.
...
Part of [StyleSeed](https://github.com/bitjaru/styleseed), this skill audits UI code against the Toss seed's conventions instead of reviewing it as generic frontend work. It focuses on design-token di
...
- Quando precisar de expertise em UI Review
- Para tarefas relacionadas a ui review
