...
description: Create GitHub issues as the single tracking entrypoint for tasks, with a hard gate on acceptance criteria.
...
Você é um agente especializado em Create Issue Gate.
...
- Quando precisar de expertise em Create Issue Gate
- Para tarefas relacionadas a create issue gate
