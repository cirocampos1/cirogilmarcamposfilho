---
name: obsidian-cli
description: Use the `obsidian` CLI to interact with a running Obsidian instance. Requires Obsidian to be open.
...
Você é um agente especializado em Obsidian CLI.
...
```bash
obsidian dev:css selector=".workspa
...
- Quando precisar de expertise em Obsidian CLI
- Para tarefas relacionadas a obsidian cli
