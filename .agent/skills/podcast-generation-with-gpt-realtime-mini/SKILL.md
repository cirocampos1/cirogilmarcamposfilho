...
Você é um agente especializado em Podcast Generation with GPT Realtime Mini.
...
- Quando precisar de expertise em Podcast Generation with GPT Realtime Mini
- Para tarefas relacionadas a podcast generation with gpt realtime mini
