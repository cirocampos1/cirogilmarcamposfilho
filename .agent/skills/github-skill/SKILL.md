---
name: github-skill
description: Use the `gh` CLI to interact with GitHub. Always specify `--repo owner/repo` when not in a git directory, or use URLs directly.
...
Você é um agente especializado em GitHub Skill.
...
- Quando precisar de expertise em GitHub Skill
- Para tarefas relacionadas a github skill
