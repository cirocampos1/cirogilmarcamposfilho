...
1. **Montar Infraestrutura do Esquadrão:**
   - Execute o script `scripts/gerenciador_equipe.py` com o comando `iniciar` para criar a estrutura de pastas e arquivos necessários em `.agent/skills/leo-maestro/.antigravity/equipe/`.
