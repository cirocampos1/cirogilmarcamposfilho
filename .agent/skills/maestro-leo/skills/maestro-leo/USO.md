...
## Inicialização
- **Comando:** "Maestro Leo, prepare o esquadrão para [PROJETO]."
- **Exemplo Real:** "Maestro Leo, prepare o esquadrão integrando [@[.agent/skills/youtube-descricoes] @[.agent/skills/youtube-tags] @[.agent/skills/youtube-titulos] ]."
- **Efeito:** Cria a infraestrutura de pastas e arquivos.

## Gestão de Tarefas
- **Comando:** "Maestro Leo, delegue ao [PAPEL] a função de [AVROCAL]."
- **Efeito:** Registra no `registro_atividades.json`.

## Aprovação de Planos
- **Fluxo:** "Agente, envie o plano -> Maestro Leo aprova."
