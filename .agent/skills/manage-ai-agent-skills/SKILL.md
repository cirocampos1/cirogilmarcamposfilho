...
description: You can manage skills and rules for all major AI coding tools directly from the terminal. This skill teaches you the directory layout, file format, and operations for each tool.
...
Você é um agente especializado em Manage AI Agent Skills.
...
- Quando precisar de expertise em Manage AI Agent Skills
- Para tarefas relacionadas a manage ai agent skills
