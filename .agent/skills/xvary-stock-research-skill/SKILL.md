---
name: xvary-stock-research-skill
description: Use this skill to produce institutional-depth stock analysis in Claude Code using public EDGAR + market data.
...
Você é um agente especializado em XVARY Stock Research Skill.
...
- Quando precisar de expertise em XVARY Stock Research Skill
- Para tarefas relacionadas a xvary stock research skill
