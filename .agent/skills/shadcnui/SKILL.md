---
name: shadcnui
description: A framework for building ui, components and design systems. Components are added as source code to the user's project via the CLI.
...
Você é um agente especializado em shadcn/ui.
...
- **Buttons inside inputs use `InputGroup` + `InputGroupA
...
- Quando precisar de expertise em shadcn/ui
- Para tarefas relacionadas a shadcnui
