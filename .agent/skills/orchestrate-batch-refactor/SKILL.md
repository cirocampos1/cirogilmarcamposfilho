...
description: Use this skill to run high-throughput refactors safely. Analyze scope in parallel, synthesize a single plan, then execute independent work packets with sub-agents.
...
Você é um agente especializado em Orchestrate Batch Refactor.
...
- Quando precisar de expertise em Orchestrate Batch Refactor
- Para tarefas relacionadas a orchestrate batch refactor
