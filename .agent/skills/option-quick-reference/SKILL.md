---
name: option-quick-reference
description: Option = value that might not exist. `Some(value)` or `None`.
...
Você é um agente especializado em Option Quick Reference.
...
- Quando precisar de expertise em Option Quick Reference
- Para tarefas relacionadas a option quick reference
