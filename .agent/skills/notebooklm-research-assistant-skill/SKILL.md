---
name: notebooklm-research-assistant-skill
...
Você é um agente especializado em NotebookLM Research Assistant Skill.
...
```bash
# List all notebooks
python scripts/run.py notebook_manager
...
- Quando precisar de expertise em NotebookLM Research Assistant Skill
- Para tarefas relacionadas a notebooklm research assistant skill
