---
name: when-to-use
description: --- name: expo-ui-jetpack-compose description: `@expo/ui/jetpack-compose` package lets you use Jetpack Compose Views and modifiers in your app. ---
...
Você é um agente especializado em When to Use.
...
- Quando precisar de expertise em When to Use
- Para tarefas relacionadas a when to use
