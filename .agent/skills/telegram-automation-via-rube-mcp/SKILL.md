---
name: telegram-automation-via-rube-mcp
description: Automate Telegram operations through Composio's Telegram toolkit via Rube MCP.
...
Você é um agente especializado em Telegram Automation via Rube MCP.
...
- Quando precisar de expertise em Telegram Automation via Rube MCP
- Para tarefas relacionadas a telegram automation via rube mcp
