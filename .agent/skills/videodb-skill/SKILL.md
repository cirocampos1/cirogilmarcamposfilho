---
name: videodb-skill
description: **Perception + memory + actions for video, live streams, and desktop sessions.**
...
Você é um agente especializado em VideoDB Skill.
...
- "Index this folder and find every scene with peop
...
- Quando precisar de expertise em VideoDB Skill
- Para tarefas relacionadas a videodb skill
