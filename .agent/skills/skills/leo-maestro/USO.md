...
## Inicialização
- **Comando:** "LeoMaster, prepare o esquadrão para [PROJETO]."
- **Exemplo Real:** "LeoMaster, prepare o esquadrão integrando [@[c:\python-projects\orquestrador\.agent\skills\youtube-descricoes] @[c:\python-projects\orquestrador\.agent\skills\youtube-tags] @[c:\python-projects\orquestrador\.agent\skills\youtube-titulos] ]."
- **Efeito:** Cria a infraestrutura de pastas e arquivos.

## Gestão de Tarefas
- **Comando:** "LeoMaster, delegue ao [PAPEL] a função de [AVROCAL]."
- **Efeito:** Registra no `registro_atividades.json`.

## Aprovação de Planos
- **Fluxo:** "Agente, envie o plano -> LeoMaster aprova."
