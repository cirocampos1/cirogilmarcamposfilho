...
description: Use this skill to diagnose SwiftUI performance issues from code first, then request profiling evidence when code review alone cannot explain the symptoms.
...
Você é um agente especializado em SwiftUI Performance Audit.
...
- Quando precisar de expertise em SwiftUI Performance Audit
- Para tarefas relacionadas a swiftui performance audit
