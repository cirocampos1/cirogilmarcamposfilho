...
description: This skill covers production-grade techniques for evaluating LLM outputs using LLMs as judges. It synthesizes research from academic papers, industry practices, and practical implementation experience
...
Você é um agente especializado em Advanced Evaluation.
...
**Verbosity Bias**: Detailed explanations receive higher scores even when unnecessary. Mitigat
...
- Quando precisar de expertise em Advanced Evaluation
- Para tarefas relacionadas a advanced evaluation
