...
Você é um agente especializado em Active Directory Attacks.
...
# Using CrackMapExec
crackmapexec smb 10.10.10.10 -u users.txt -p 'P
...
- Quando precisar de expertise em Active Directory Attacks
- Para tarefas relacionadas a active directory attacks
