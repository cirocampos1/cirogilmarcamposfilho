---
name: apple-hig-design-foundations
...
Você é um agente especializado em Apple HIG: Design Foundations.
...
| [inclusion.md](references/inclusion.md) | Inclusion | Dive
...
- Quando precisar de expertise em Apple HIG: Design Foundations
- Para tarefas relacionadas a apple hig design foundations
