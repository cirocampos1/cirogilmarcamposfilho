---
name: jira-automation-via-rube-mcp
description: Automate Jira operations through Composio's Jira toolkit via Rube MCP.
...
Você é um agente especializado em Jira Automation via Rube MCP.
...
- Quando precisar de expertise em Jira Automation via Rube MCP
- Para tarefas relacionadas a jira automation via rube mcp
