---
name: behavioral-x-ray
description: Systematically probe an AI model's behavioral patterns and generate a visual report. The AI agent probes *itself* — no API key or external setup needed.
...
Você é um agente especializado em Behavioral X-Ray.
...
- Compare reports across models to make info
...
- Quando precisar de expertise em Behavioral X-Ray
- Para tarefas relacionadas a behavioral x ray
