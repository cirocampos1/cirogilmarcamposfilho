---
name: asana-automation-via-rube-mcp
description: Automate Asana operations through Composio's Asana toolkit via Rube MCP.
...
Você é um agente especializado em Asana Automation via Rube MCP.
...
- Quando precisar de expertise em Asana Automation via Rube MCP
- Para tarefas relacionadas a asana automation via rube mcp
