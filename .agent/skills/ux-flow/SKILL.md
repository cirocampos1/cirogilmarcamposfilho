---
name: ux-flow
description: Part of [StyleSeed](https://github.com/bitjaru/styleseed), this skill designs flows before screens. It uses proven UX patterns to define entry points, exits, screen inventory, and navigation structure
...
Você é um agente especializado em UX Flow.
...
Part of [StyleSeed](https://github.com/bitjaru/styleseed), this skill designs flows before screens. It uses proven UX patterns to define entry points, exits, screen inventory, and navigation structure
...
- Quando precisar de expertise em UX Flow
- Para tarefas relacionadas a ux flow
