---
name: ui-tokens
description: Part of [StyleSeed](https://github.com/bitjaru/styleseed), this skill manages design tokens without letting the source-of-truth files drift apart. It is meant for teams using the Toss seed's JSON toke
...
Você é um agente especializado em UI Tokens.
...
Part of [StyleSeed](https://github.com/bitjaru/styleseed), this skill manages design tokens without letting the source-of-truth files drift apart. It is meant for teams using the Toss seed's JSON toke
...
- Quando precisar de expertise em UI Tokens
- Para tarefas relacionadas a ui tokens
