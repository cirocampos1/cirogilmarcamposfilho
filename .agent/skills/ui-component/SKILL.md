---
name: ui-component
description: Part of [StyleSeed](https://github.com/bitjaru/styleseed), this skill generates components that respect the Toss seed's design language instead of improvising ad hoc markup and styling. It emphasizes 
...
Você é um agente especializado em UI Component.
...
Part of [StyleSeed](https://github.com/bitjaru/styleseed), this skill generates components that respect the Toss seed's design language instead of improvising ad hoc markup and styling. It emphasizes 
...
- Quando precisar de expertise em UI Component
- Para tarefas relacionadas a ui component
