...
Você é um agente especializado em Error Handling Patterns.
...
- Quando precisar de expertise em Error Handling Patterns
- Para tarefas relacionadas a error handling patterns
