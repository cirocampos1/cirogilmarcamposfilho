---
name: zoho-crm-automation-via-rube-mcp
description: Automate Zoho CRM operations through Composio's Zoho toolkit via Rube MCP.
...
Você é um agente especializado em Zoho CRM Automation via Rube MCP.
...
- Creating duplicates is allowed unless duplicate chec
...
- Quando precisar de expertise em Zoho CRM Automation via Rube MCP
- Para tarefas relacionadas a zoho crm automation via rube mcp
