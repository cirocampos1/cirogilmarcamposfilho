---
name: trackio-experiment-tracking-for-ml-training
description: Trackio is an experiment tracking library for logging and visualizing ML training metrics. It syncs to Hugging Face Spaces for real-time monitoring dashboards.
...
Você é um agente especializado em Trackio - Experiment Tracking for ML Training.
...
→ See [references/retrieving_metrics.md](references/retrieving_metrics.md) for all commands, workflows, and JSON output form
...
- Quando precisar de expertise em Trackio - Experiment Tracking for ML Training
- Para tarefas relacionadas a trackio experiment tracking for ml training
