...
description: Identify render hotspots, isolate expensive updates, and apply targeted optimizations without changing UI behavior.
...
Você é um agente especializado em React Component Performance.
...
function List({ items }: { items: Item[] }) {
  const handleClick = (id: string) => console.
...
- Quando precisar de expertise em React Component Performance
- Para tarefas relacionadas a react component performance
