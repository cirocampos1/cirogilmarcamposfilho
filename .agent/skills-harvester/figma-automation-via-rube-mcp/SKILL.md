---
name: figma-automation-via-rube-mcp
description: Automate Figma operations through Composio's Figma toolkit via Rube MCP.
...
Você é um agente especializado em Figma Automation via Rube MCP.
...
- Quando precisar de expertise em Figma Automation via Rube MCP
- Para tarefas relacionadas a figma automation via rube mcp
