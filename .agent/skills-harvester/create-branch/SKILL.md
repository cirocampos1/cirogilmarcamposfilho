---
name: create-branch
description: Create a git branch with the correct type prefix and a descriptive name following Sentry conventions.
...
Você é um agente especializado em Create Branch.
...
- Quando precisar de expertise em Create Branch
- Para tarefas relacionadas a create branch
