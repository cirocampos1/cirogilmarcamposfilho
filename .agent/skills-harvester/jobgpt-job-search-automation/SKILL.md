---
name: jobgpt-job-search-automation
description: JobGPT connects your AI assistant to a complete job search automation platform via the JobGPT MCP server. It provides 34 tools covering job search, auto-apply, resume generation, application tracking,
...
Você é um agente especializado em JobGPT - Job Search Automation.
...
> "Apply to this job for me - https://boards.greenhouse.io
...
JobGPT connects your AI assistant to a complete job search automation platform via the JobGPT MCP server. It provides 34 tools covering job search, auto-apply, resume generation, application tracking,
...
- Quando precisar de expertise em JobGPT - Job Search Automation
- Para tarefas relacionadas a jobgpt job search automation
