---
name: ui-pattern
description: Part of [StyleSeed](https://github.com/bitjaru/styleseed), this skill builds reusable composed patterns from the seed's primitives. It is intended for sections like card lists, grids, form blocks, ran
...
Você é um agente especializado em UI Pattern.
...
Part of [StyleSeed](https://github.com/bitjaru/styleseed), this skill builds reusable composed patterns from the seed's primitives. It is intended for sections like card lists, grids, form blocks, ran
...
- Quando precisar de expertise em UI Pattern
- Para tarefas relacionadas a ui pattern
