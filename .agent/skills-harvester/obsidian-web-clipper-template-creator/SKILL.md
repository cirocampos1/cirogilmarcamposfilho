---
name: obsidian-web-clipper-template-creator
description: This skill helps you create importable JSON templates for the Obsidian Web Clipper.
...
Você é um agente especializado em Obsidian Web Clipper Template Creator.
...
- **Document the target element** in yo
...
- Quando precisar de expertise em Obsidian Web Clipper Template Creator
- Para tarefas relacionadas a obsidian web clipper template creator
