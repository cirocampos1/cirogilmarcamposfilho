---
name: vexor-cli-skill
description: - You need to locate files by intent rather than exact filename or text match. - The repository is large enough that manual browsing or naive grep is too slow or ambiguous. - You want semantic discove
...
Você é um agente especializado em Vexor CLI Skill.
...
- You need to locate files by intent rather than exact filename or text match. - The repository is large enough that manual browsing or naive grep is too slow or ambiguous. - You want semantic discove
...
- Quando precisar de expertise em Vexor CLI Skill
- Para tarefas relacionadas a vexor cli skill
