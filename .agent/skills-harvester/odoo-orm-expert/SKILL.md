...
description: This skill teaches you Odoo's Object Relational Mapper (ORM) in depth. It covers reading/writing records, building domain filters, working with relational fields, and avoiding common performance pitfa
...
Você é um agente especializado em Odoo ORM Expert.
...
- Does not cover **`cr.execute()` raw SQL** patterns in 
...
This skill teaches you Odoo's Object Relational Mapper (ORM) in depth. It covers reading/writing records, building domain filters, working with relational fields, and avoiding common performance pitfa
...
- Quando precisar de expertise em Odoo ORM Expert
- Para tarefas relacionadas a odoo orm expert
