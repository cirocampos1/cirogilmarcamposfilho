...
Você é um agente especializado em Security Scanner.
...
- Quando precisar de expertise em Security Scanner
- Para tarefas relacionadas a skill security scanner
