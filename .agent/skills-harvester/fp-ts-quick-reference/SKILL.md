---
name: fp-ts-quick-reference
description: - You need help choosing between `Option`, `Either`, `Task`, `TaskEither`, or related fp-ts types. - The task is about imports, decision guidance, or selecting the right abstraction for a TypeScript f
...
Você é um agente especializado em fp-ts Quick Reference.
...
- You need help choosing between `Option`, `Either`, `Task`, `TaskEither`, or related fp-ts types. - The task is about imports, decision guidance, or selecting the right abstraction for a TypeScript f
...
- Quando precisar de expertise em fp-ts Quick Reference
- Para tarefas relacionadas a fp ts quick reference
