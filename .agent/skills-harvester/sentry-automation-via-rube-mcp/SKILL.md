---
name: sentry-automation-via-rube-mcp
description: Automate Sentry error tracking and monitoring operations through Composio's Sentry toolkit via Rube MCP.
...
Você é um agente especializado em Sentry Automation via Rube MCP.
...
- Quando precisar de expertise em Sentry Automation via Rube MCP
- Para tarefas relacionadas a sentry automation via rube mcp
