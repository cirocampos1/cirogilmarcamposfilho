---
name: postmark-automation-via-rube-mcp
description: Automate Postmark transactional email operations through Composio's Postmark toolkit via Rube MCP.
...
Você é um agente especializado em Postmark Automation via Rube MCP.
...
- Quando precisar de expertise em Postmark Automation via Rube MCP
- Para tarefas relacionadas a postmark automation via rube mcp
