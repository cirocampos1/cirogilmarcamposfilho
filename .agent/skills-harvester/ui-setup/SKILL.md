---
name: ui-setup
description: Part of [StyleSeed](https://github.com/bitjaru/styleseed), this setup wizard turns a raw project into a design-system-guided workspace. It collects the minimum brand and product context needed to conf
...
Você é um agente especializado em UI Setup.
...
4. Any follow-up recommendations for co
...
Part of [StyleSeed](https://github.com/bitjaru/styleseed), this setup wizard turns a raw project into a design-system-guided workspace. It collects the minimum brand and product context needed to conf
...
- Quando precisar de expertise em UI Setup
- Para tarefas relacionadas a ui setup
