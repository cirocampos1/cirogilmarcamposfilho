---
name: adhx-xtwitter-post-reader
description: Fetch any X/Twitter post as structured JSON for analysis using the ADHX API.
...
Você é um agente especializado em ADHX - X/Twitter Post Reader.
...
User: "How many likes did this tweet get? h
...
- Quando precisar de expertise em ADHX - X/Twitter Post Reader
- Para tarefas relacionadas a adhx xtwitter post reader
