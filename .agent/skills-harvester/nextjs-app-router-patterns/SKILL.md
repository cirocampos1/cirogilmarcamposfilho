...
Você é um agente especializado em Next.js App Router Patterns.
...
- Quando precisar de expertise em Next.js App Router Patterns
- Para tarefas relacionadas a nextjs app router patterns
