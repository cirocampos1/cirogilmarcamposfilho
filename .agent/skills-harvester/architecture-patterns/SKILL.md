...
Você é um agente especializado em Architecture Patterns.
...
- Quando precisar de expertise em Architecture Patterns
- Para tarefas relacionadas a architecture patterns
