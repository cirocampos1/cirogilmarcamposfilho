---
name: twitterx-automation-via-rube-mcp
description: Automate Twitter/X operations through Composio's Twitter toolkit via Rube MCP.
...
Você é um agente especializado em Twitter/X Automation via Rube MCP.
...
- Quando precisar de expertise em Twitter/X Automation via Rube MCP
- Para tarefas relacionadas a twitterx automation via rube mcp
