---
name: animejs-animation-skill
description: [Anime.js](https://animejs.com/) is a lightweight but extremely powerful JavaScript animation engine. It excels at complex timelines, staggering, and precise control over DOM, CSS, and SVGs.
...
Você é um agente especializado em Anime.js Animation Skill.
...
- Quando precisar de expertise em Anime.js Animation Skill
- Para tarefas relacionadas a animejs animation skill
